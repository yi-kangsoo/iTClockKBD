...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_QWERTY] = LAYOUT(
            ...
            //  _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______,
             ...
             MO(_RAISE), KC_CAPS, KC_LOPT, KC_LCMD, KC_SPC,  KC_BSPC,           KC_SPC,  KC_SPC,  KC_LBRC, KC_RBRC, KC_LEFT, KC_RGHT,
                                                 MO(_RAISE), MO(_LOWER),        KC_ENT,  MO(_RAISE)
        ),
        [_LOWER] = LAYOUT(
                KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,             KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
            //  _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______,
                KC_ESC,  _______, KC_UP,   _______, _______, _______,           KC_BRIU, KC_BRID, KC_UP,   _______, _______, _______,
                _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_LBRC,           KC_LBRC, KC_LEFT, KC_DOWN, KC_RGHT, KC_RBRC, _______,
                _______, _______, _______, _______, _______, KC_LPRN,           KC_MCTL, KC_LPAD, _______, _______, _______, _______,
                _______, _______, _______, _______, _______, KC_PGUP,           KC_PGDN, _______, KC_GRV,  KC_BSLS, _______, _______,
        ...
        [_RAISE] = LAYOUT(
            ...
            //  _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______,
                ...
                _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______,           KC_4,    KC_5,    KC_6,    KC_WH_U, KC_WH_D, _______,
                _______, _______, _______, _______, _______, _______,           KC_1,    KC_2,    KC_3,    KC_WH_R, KC_WH_L, _______,
                _______, _______, _______, _______, _______, _______,           KC_0,    KC_0,    KC_0,    _______, _______, M_COPY,
